              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full h-10 rounded-lg border border-white/20 bg-brand-surface px-3 py-2 text-sm text-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-accent"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full rounded-lg border border-white/20 bg-brand-surface px-3 py-2 text-sm text-brand-primary placeholder:text-brand-secondary focus:outline-none focus:ring-2 focus:ring-brand-accent resize-none"
